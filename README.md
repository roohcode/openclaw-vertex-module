...
```bash
git clone https://github.com/YOUR_USERNAME/openclaw-vertex-module.git
...
|---|---|---|
| `gemini-1.5-pro-001` | **Gemini 1.5 Pro** | Best for reasoning, coding, long context (1M tokens). |
| `gemini-1.5-flash-001` | **Gemini 1.5 Flash** | Fast, efficient, long context (1M tokens). |
